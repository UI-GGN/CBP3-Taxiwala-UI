...
export const AdminHome: React.FC = (): ReactElement => {
  ...
  return  <>
    ...
    <Box style={{marginTop: "3rem", position: "relative"}}>
      <img src={theme.palette.mode === "light"?adminSat:adminSat} alt="cab parked" className="admin_coverimg" />
      <Typography variant="h4" style={{position: "absolute", top: "7rem", left: "30px", color: "white"}}><b>Admin Access</b></Typography>
    </Box>
    <Box sx={{ width: "100%" }}>
